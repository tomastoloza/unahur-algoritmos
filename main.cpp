...
//    conditionalStructures.getMaxNumber();
//    conditionalStructures.isEven();
//    conditionalStructures.isDivisible();
//    conditionalStructures.arithmeticMenu();
